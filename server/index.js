...
app.use(function (req, res, next) {
    ...
    res.setHeader('Access-Control-Allow-Origin', 'http://test.millionverse.live:3000');
...
// app.post("/:network/:token/:address/:captcha", function (req, res) {
